# -*- coding: utf-8 -*-
"""
Created on Tue May 11 14:54:51 2021
...
class ObjCenter:
	...
	def update(self, frame, frameCenter=None):
		...
		rects = self.detector.detectMultiScale(gray, scaleFactor=self.scale_factor,minNeighbors=20,minSize=(40, 40),flags=cv2.CASCADE_SCALE_IMAGE)
