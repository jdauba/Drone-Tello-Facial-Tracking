...
#face_detection = wget.download("https://raw.githubusercontent.com/opencv/opencv/master/data/lbpcascades/lbpcascade_frontalface.xml")
#face_center= ObjCenter("lbpcascade_frontalface.xml")
...
wref = 75
#kp=1.8
forward_pid = PID(kP=1.7, kI=0.0001, kD=0.1)
forward_pid.initialize()
K_forward = 1.6
K_backward = 0.4
K_up = 3
# Max speed :
max_speed_threshold = 110
search_speed = 65
#Init:
left_right_error = 0
count = 0
